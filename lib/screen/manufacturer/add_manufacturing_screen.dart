...
class AddManufacturingScreen extends StatefulWidget {
  ...
  const AddManufacturingScreen({Key? key, required this.rawMatShpId}) : super(key: key);
...
final List<String> itemList=[]; //
 ...
 void fetchData (String rawMatShpId) async {
  var username = await SessionManager().get("username");
    ...
    var response = await rawMaterialShippingController.getRawMaterialShippingDetails(rawMatShpId);
    //var response = await plantingController.getPlantingrDetails(plantingId);
    rawMaterialShipping = RawMaterialShipping.fromJsonToRawMaterialShipping(response);
    products = await productController.getListProduct(username);
  //  print(rawMaterialShipping?.planting?.plantName);
     plantNameTextController.text = rawMaterialShipping?.planting?.plantName ?? "";
    fetchName();
    //setTextToData();
    setState(() {
      isLoaded = true;
                              ...
                              children: [
                                ...
                                /*  Center(
                                  child: DropdownButton<String>(
                                    ...
                                    items: productNames?.map((String item) => DropdownMenuItem<String>(
                                      value: item,
                                      child: Text(item)
                                      ),
                                    ).toList(),
                                ...
                                CustomTextFormField(
                                 ...
                                 Center(
                                  child: DropdownButton<String>(
                                    ...
                                    items:  productUnit_items.map((String item) => DropdownMenuItem<String>(
                                      value: item,
                                      child: Text(item)
                                      ),
                                    ).toList(),
                                    onChanged: (item) => setState(() => selected_productUnit_items = item),
                                  ),
                                ),
                                  ...
                                  child: TextFormField(
                                    onTap: () async {
                                      ...
                                      setState(() {
                                        ...
                                        manufactureDateTextController.text = dateFormat.format( manufactureDate!);
                                      });
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    onTap: () async {
                                      ...
                                      setState(() {
                                        expireDate = tempDate;
                                        expireDateTextController.text = dateFormat.format(expireDate!);
                                      });
                                      print(expireDate);
                                    },
                                    readOnly: true,
                                ...
                                CustomTextFormField(
                                 ...
                                 Center(
                                  child: DropdownButton<String>(
                                    ...
                                    items:  usedRawMatQtyUnit_items.map((String item) => DropdownMenuItem<String>(
                                      value: item,
                                      child: Text(item)
                                      ),
                                    ).toList(),
                                    onChanged: (item) => setState(() => selected_usedRawMatQtyUnit_items = item),
                                  ),
                                ),
                                      ...
                                      onPressed: () async {
                                        if (formKey.currentState!.validate()) {
                                          ...
                                          */
                                          ...
                                          var username = await SessionManager().get("username");
/*
                                          http.Response response = await manufacturingController.addManufacturing(plantNameTextController.text,
